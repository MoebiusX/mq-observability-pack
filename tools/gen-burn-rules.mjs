...
//
// Four deliberate deviations from that compiler's PromQL, each found by running the rules
...
const header = [
  ...
  '# header lists the four PromQL deviations (bad/expected-sample ratios, short-window floor,',
  '# sustained-burn forecasts, lab for:). Regenerate: npm run burn-rules',
  '',
];
