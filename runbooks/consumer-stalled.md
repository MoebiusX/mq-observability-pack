...
2. Consumer logs/traces: Jaeger service `orders-consumer` — are `receive` spans still being produced? Errors on GET (2033 is normal on an empty queue; anything else is not)?
